 ...
 * Set value for atom
 * 
 * @param {atom}  atom  Atom for set of value
 * @param {T}     value Setted value
 */
export function set (atom, value) {
  let newAtom = atom.set('value', value);

  atom.get('listeners').forEach(function (listener) {
    listener(newAtom, atom, value);
  });
